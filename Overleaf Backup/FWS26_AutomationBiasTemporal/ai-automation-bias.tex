...
More specifically, we disguised the \Gls{pwa} as a normal application and not as a website in order to establish greater authenticity for the participant (see \ref{sec:pwa}).
