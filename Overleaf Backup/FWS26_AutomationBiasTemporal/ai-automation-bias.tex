...
\title[AI Fallibility \& Automation Bias long-term Effects]{The long-term effect of indicating AI fallibility on automation bias in mental health application users.}
...
Automation bias is modelled as a continuous function that maps
...
We define a reference threshold based on a minimally biased configuration:
...
\begin{enumerate}
    ...
    \textit{"Wir haben einen App für eine KI für mentale Gesundheit vorbereitet. 
Sie kann Fälle von Patienten einschätzen und Vorschläge für Behandlungen geben."}
    ...
    \begin{itemize}
        \item How do rate the AI Answer?\\
...
\section{Palloc Python Implementation}
