...
\begin{document}
\begin{abstract}
This study examined the short- and long-term effects of disclaimer messages on participants’ evaluations of \gls{ai}-generated mental health recommendations, focusing automation bias.
...
As AI-based applications become increasingly accessible to the general population, they may also help alleviate some of the pressure on already overburdened healthcare systems. Machine learning algorithms already show efficacy in classifying mental disorders and treatment responses, which suggests a promising potential \autocite[]{gonzalez_systematic_review}.
...
Consequently, this study examines the impact of warning nudges—in the form of disclaimers—on users’ reliance on \Gls{ai} within a mental health context. These disclaimers will be integrated into a PWA which we have designed specifically for this study. 
