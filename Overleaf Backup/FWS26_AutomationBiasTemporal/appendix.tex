...
\label{app:palloc}
\textattachfile[color=0 0 0]{allocate.py}{Our one and only version of allocate.py} \faDownload
...
%         \centering
%         \includegraphics[page=1,width=\linewidth]{assets/vignettes/Amina-en-GB.pdf}
%         \caption{Amina}
%         \label{fig:app:Amina}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}{0.32\textwidth}
%         \centering
%         \includegraphics[page=1,width=\linewidth]{assets/vignettes/Aylin-en-GB.pdf}
%         \caption{Aylin}
%         \label{fig:app:Aylin}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}{0.32\textwidth}
%         \centering
%         \includegraphics[page=1,width=\linewidth]{assets/vignettes/Lena-en-GB.pdf}
%         \caption{Lena}
%         \label{fig:app:Lena}
%     \end{subfigure}
...
%     \begin{subfigure}{0.32\textwidth}
%         \centering
%         \includegraphics[page=1,width=\linewidth]{assets/vignettes/Martina-en-GB.pdf}
%         \caption{Martina}
...
%     \begin{subfigure}{0.32\textwidth}
%         \centering
%         \includegraphics[page=1,width=\linewidth]{assets/vignettes/Mathias-en-GB.pdf}
%         \caption{Mathias}
%         \label{fig:app:Mathias}
%     \end{subfigure}

%     \caption{Vignettes overview}
%     \label{fig:app:vignettes}
% \end{figure}
